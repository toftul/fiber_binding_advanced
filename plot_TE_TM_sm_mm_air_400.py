...
z_space, Fz_TE = np.load('npy_data/Fz_air_TE_sm.npy')
z_space, Fz_TM = np.load('npy_data/Fz_air_TM_sm.npy')
z_space, Fz_TE_mm = np.load('npy_data/Fz_air_TE_mm.npy')
z_space, Fz_TM_mm = np.load('npy_data/Fz_air_TM_mm.npy')
...
axins = zoomed_inset_axes(ax, 9.9, loc=8)
