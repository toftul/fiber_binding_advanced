...
z_space, Fz_TE = np.load('npy_data/Fz_air_TE_sm330.npy')
z_space, Fz_TM = np.load('npy_data/Fz_air_TM_sm330.npy')
z_space, Fz_TE_mm = np.load('npy_data/Fz_air_TE_mm330.npy')
z_space, Fz_TM_mm = np.load('npy_data/Fz_air_TM_mm330.npy')
